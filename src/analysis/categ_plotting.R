...
N_file  <- "/Users/akond/Documents/AkondOneDrive/OneDrive/IaC-Defect-Categ-Project/output/size_per_categ/N_.csv"
...
plotData <- function(T_size_P, I_size_P, D_size_P, F_size_P, C_size_P, B_size_P, O_size_P, N_size_P, AS_size_P, AL_size_P, yLab_P, yLimP)
{
  ...
  boxplot(T_size_P, I_size_P, D_size_P, F_size_P, C_size_P, B_size_P, O_size_P, N_size_P, AS_size_P, AL_size_P, 
          col=c("magenta", "cyan", "yellow", "orange", "peachpuff3", "grey", "cornflowerblue", "green", "red", "purple"), 
  ...
  all_the_means <-c(mean(T_size_P, na.rm=TRUE), mean(I_size_P, na.rm=TRUE), mean(D_size_P, na.rm=TRUE), 
                ...
                mean(B_size_P, na.rm=TRUE), mean(O_size_P, na.rm=TRUE), mean(N_size_P, na.rm=TRUE), 
                mean(AS_size_P, na.rm=TRUE), mean(AL_size_P, na.rm=TRUE))
  points(x = 1:10, y=all_the_means, pch=15)
